...
const AdmissionPage = () => {
    return(
        <div>
            ...
            <p>For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our Courses page or Contact us directly.s</p>
        </div>
    )
}
